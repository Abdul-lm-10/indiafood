...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post("https://api.indiafoodshop.com/admin/contact-us", formData); // Adjust your API base URL if needed
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-7">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    {submitStatus === "error" && (
                                        <div className="text-danger mt-2">Failed to send message.</div>
                                    )}
                                </form>
                            </div>
                            <div class="col-lg-5">
